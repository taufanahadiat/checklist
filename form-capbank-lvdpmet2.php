...
<table> 
    <h2>
        ...
        <br>
        <span style="font-weight:200;">Lokasi: <span style="font-weight:550;">LVDP MET 2</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Bulan: <span style="font-weight:550;"><?php echo $nama_bulan?></span></span>
    </h2>
    <?php include 'pilih-unit-capbank.php'; ?>
        <thead>
        <tr>
             <th style="width:3%;">Nomor Unit</th>
