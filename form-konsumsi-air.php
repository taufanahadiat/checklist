    ...
    <?php
        ...
        <?php for ($j = 1; $j <= 7; $j++): ?>
            ...
            <td id="<?php echo $i ?>_meter_dwp<?php echo $j ?>"
                ...
                <?php
                if (isset(${"record_$date"}) && isset(${"record_$date"}["meter_dwp$j"])) {
                    echo "<div class='form-row' style='padding: 2px;'>";
                    echo htmlspecialchars(formatValue(${"record_$date"}["meter_dwp$j"]));
                    echo "&nbsp;<button type='button' class='clear-btn' data-tanggal='$date' onclick='clearField(this)' data-field='meter_dwp$j'>X</button></div>";
                } else {
                    echo "<input type='number' step='0.01' data-tanggal='$date' class='input-field' name='meter_dwp$j'>";
                }
                ?>
            </td>
        ...
        <?php endfor; ?>
            <td id="<?php echo $i ?>_meter_gudang7"
                ...
                <?php 
                if (isset(${"record_$date"}) && isset(${"record_$date"}["meter_gudang7"])) {
                    echo "<div class='form-row' style='padding: 2px;'>";
                    echo htmlspecialchars(formatValue(${"record_$date"}["meter_gudang7"]));
                    echo "&nbsp;<button type='button' class='clear-btn' data-tanggal='$date' onclick='clearField(this)' data-field='meter_gudang7'>X</button></div>";
                } else {
                    echo "<input type='number' step='0.01' data-tanggal='$date' class='input-field' name='meter_gudang7'>";
                }
                ?>
            </td>
        ...
        <?php foreach ($outlet_fields as $outlet): ?>
            <td id="<?php echo $i ?>_count_<?php echo $outlet ?>" 
                ...
                <?php 
                if (isset(${"record_$date"}) && isset(${"record_$date"}["count_$outlet"])) {
                    echo "<div class='form-row' style='padding: 2px;'>";
                    echo htmlspecialchars(formatValue(${"record_$date"}["count_$outlet"]));
                    echo "&nbsp;<button type='button' class='clear-btn' data-tanggal='$date' onclick='clearField(this)' data-field='count_$outlet'>X</button></div>";
                } else {
                    echo "<input type='number' step='0.01' data-tanggal='$date' class='input-field' name='count_$outlet'>";
                }
                ?>
            </td>
        ...
        <?php if (${"record_$date"} && isset(${"record_$date"}["level_old_dwt"])) : ?>
