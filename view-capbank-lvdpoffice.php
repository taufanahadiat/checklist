<?php 
    $unit = 'capbank_lvdpoffice'; 
    require 'database.php';
    include 'request-view-capbank.php';
?>
    <br>
    <h3 style="margin-bottom: -10px;">
    <span style="font-weight:200;">Nama Panel: <span style="font-weight:550;">Cap. Bank Office</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Lokasi: <span style="font-weight:550;">LVDP Office</span></span>
    </h3>
    <?php if ($article === null): ?>
        <br>
