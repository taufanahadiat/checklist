...
?>
    ...
    <h3>
        <span style="font-weight:200;">Nama Panel: <span style="font-weight:550;">LVDP CPP</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Lokasi: <span style="font-weight:550;">R. Trafo CPP</span></span>
    </h3>
    <?php if ($article === null): ?>
        <br>
    ...
    <thead>
        ...
        <?php
                $breaker = array(
                    ...
                    'ws_coating' => 'WS Coating',
                    'pp_cpp' => 'PP CPP',
                    'coating' => 'Coating',
                    'coating_3_4' => 'Coating 3-4',
                    'boiler_sentral' => 'Boiler Sentral',
                    'workshop_cpp' => 'Workshop CPP',
                    'cpp1' => 'CPP 1',
                    'incoming' => 'Incoming',
                    'cap_bank2' => 'Cap Bank',
                    'cap_bank3' => 'Cap Bank',
                    'cap_bank4' => 'Cap Bank',
                    'outgoing_met1' => 'Outgoing Met 1',
                );
                ...
                foreach ($breaker as $index => $nama) {
                    echo '<tr>';
                    if($index == 'ws_coating' || $index == 'coating' || $index == 'coating_3_4' || $index == 'workshop_cpp' || $index == 'cpp1') {
...
<?php endif;?>
<span class="legalDoc" style="margin-top: -15px;">H1-LVCP-63-24R0</span><br><br>