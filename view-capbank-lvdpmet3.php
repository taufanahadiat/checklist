<?php 
    $unit = 'capbank_lvdpmet3'; 
    require 'database.php';
    include 'request-view-capbank.php';
?>
    <br>
    <h3 style="margin-bottom: -10px;">
    <span style="font-weight:200;">Nama Panel: <span style="font-weight:550;">Cap. Bank Metalizing 3</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Lokasi: <span style="font-weight:550;">LVDP Met. 3</span></span>
    </h3>
    <?php if ($article === null): ?>
        <br>
...
<table style="width:80%; margin-left:0; margin-right:0; float:left;"> 
        ...
        <?php
                ...
                foreach ($noUnit as $index => $no) {
                    echo '<tr>';
                    echo '<th class="measure2">' . strtoupper($no) . '</th>';
